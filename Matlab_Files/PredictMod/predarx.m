function [yhat] = predarx(pmod,y,u)
%PREDICT Compute one-step predictions for arx model.
%
%	Syntax
%
%	  [YHAT] = PREDARX(PMOD,Y,U)
%
%	Description
%
%	  PREDARX computes the one-step-ahead predition errors for an 
%	  arx prediction model PMOD.
%
...
%	Algorithm
%
%	  PREDARX assumes the system model is in the form
%
...
%
%	See also PREDICT, PREDBJTF, PREDARMAX, PREDARMA, PREDREGR
