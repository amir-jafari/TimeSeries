function [yhat] = predarmax(pmod,y,u)
%PREDICT Compute one-step predictions for armax model.
%
%	Syntax
%
%	  [YHAT] = PREDARMAX(PMOD,Y,U)
%
%	Description
%
%	  PREDARMAX computes the one-step-ahead predition errors for an 
%	  armax prediction model PMOD.
%
%	  PREDARMAX(PMOD,Y,U) takes,
...
%	Algorithm
%
%	  PREDARMAX assumes the system model is in the form
%
...
%
%	See also PREDICT, PREDARMA, PREDARX, PREDBJTF, PREDREGR.
