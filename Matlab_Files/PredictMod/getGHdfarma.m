function [ng,dg,nh,dh] = getGHdfarma(pmod)
%GETGH Find the G and H transfer functions for the prediction model.
%
%	Syntax
%
%	  [NG,DG,NH,DH] = GETGHDFARMA(PMOD)
%
%	Description
%
%	  GETGDFHARMA gets the G and H transfer functions for the ARMA
%	  prediction model PMOD.  It includes the differencing operators.
%
%	  GETGHDFARMA(PMOD) takes,
...
%	Algorithm
%
%	  GETGHDFARMA rearranges the system model into the form
%
%	    y(t) = H e(t)
%
